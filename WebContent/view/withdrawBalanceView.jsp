...
<body>
	<div>
		...
		<div class="container">
			...
			<div class="content">
				...
				<table id="table">
				<tr>
					<th><h2>WITHDRAW BALANCE</h2></th>
				</tr>
				<tr>
					<td></td>
				</tr>
				<tr>
					<td style="text-align:center; padding-bottom: 15px;"><label>Input Withdraw Amount: </label></td>
				</tr>
				<tr>
	...
	<script>
		function submitResult() {
			if (confirm("Are you sure to withdraw?") == false) {
				return false ;
				} else {
			    return true ;
			}
